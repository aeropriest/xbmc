...
namespace PICTURE_INFO
{
    ...
    public:
        ...
        void getTagGeoCoordinates (const CStdString strPath, CStdString& geoLatitude, CStdString& geoLongitude, CStdString& geoAltitude);
        CStdString getTagPictureDate (const CStdString strPath);
